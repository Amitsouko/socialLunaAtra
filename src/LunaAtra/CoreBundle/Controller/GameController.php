...
use LunaAtra\CoreBundle\Form\GameType;
...
class GameController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CoreBundle:Game')->findAll();
     ...
     * @Method("POST")
     * @Template("CoreBundle:Game:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CoreBundle:Game')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CoreBundle:Game:edit.html.twig")
     */
